module.exports=[13985,e=>{"use strict";var t=e.i(899378);function n(e){if(null===e)return null;try{return JSON.stringify(e)}catch{return null}}function r(e){let t=e&&"object"==typeof e?e:{};return{id:"number"==typeof t.id?t.id:0,tool:"string"==typeof t.tool?t.tool:"",currentVersion:null===t.current_version?null:"string"==typeof t.current_version?t.current_version:null,installedVersion:null===t.installed_version?null:"string"==typeof t.installed_version?t.installed_version:null,pinnedVersion:null===t.pinned_version?null:"string"==typeof t.pinned_version?t.pinned_version:null,binaryPath:null===t.binary_path?null:"string"==typeof t.binary_path?t.binary_path:null,status:"string"==typeof t.status?t.status:"not_installed",pid:null===t.pid?null:"number"==typeof t.pid?t.pid:null,port:"number"==typeof t.port?t.port:8317,apiKey:null===t.api_key?null:"string"==typeof t.api_key?t.api_key:null,managementKey:null===t.management_key?null:"string"==typeof t.management_key?t.management_key:null,autoUpdate:1===t.auto_update||!0===t.auto_update||"1"===t.auto_update,autoStart:1===t.auto_start||!0===t.auto_start||"1"===t.auto_start,lastHealthCheck:null===t.last_health_check?null:"string"==typeof t.last_health_check?t.last_health_check:null,lastUpdateCheck:null===t.last_update_check?null:"string"==typeof t.last_update_check?t.last_update_check:null,healthStatus:"string"==typeof t.health_status?t.health_status:"unknown",configOverrides:function(e){if(!e||"string"!=typeof e||""===e.trim())return null;try{let t=JSON.parse(e);return"object"==typeof t&&null!==t?t:null}catch{return null}}(t.config_overrides),errorMessage:null===t.error_message?null:"string"==typeof t.error_message?t.error_message:null,createdAt:"string"==typeof t.created_at?t.created_at:"",updatedAt:"string"==typeof t.updated_at?t.updated_at:"",logsBufferPath:null===t.logs_buffer_path?null:"string"==typeof t.logs_buffer_path?t.logs_buffer_path:null,providerExpose:1===t.provider_expose||!0===t.provider_expose||"1"===t.provider_expose,lastSyncAt:null===t.last_sync_at?null:"string"==typeof t.last_sync_at?t.last_sync_at:null}}async function a(){return(0,t.getDbInstance)().prepare("SELECT * FROM version_manager").all().map(r)}async function o(e){let n=(0,t.getDbInstance)().prepare("SELECT * FROM version_manager WHERE tool = ?").get(e);return n?r(n):null}async function i(e){(0,t.getDbInstance)().prepare(`
  ...
  `).run(e.tool,e.currentVersion??null,e.installedVersion??null,e.pinnedVersion??null,e.binaryPath??null,e.status??"not_installed",e.pid??null,e.port??8317,e.apiKey??null,e.managementKey??null,void 0!==e.autoUpdate?+!!e.autoUpdate:1,void 0!==e.autoStart?+!!e.autoStart:0,e.healthStatus??"unknown",n(e.configOverrides??null),e.errorMessage??null);let r=await o(e.tool);if(!r)throw Error("Failed to retrieve inserted version manager tool");return r}async function s(e,r){let a=(0,t.getDbInstance)();if(!await o(e))return null;let i=new Set(["currentVersion","installedVersion","pinnedVersion","binaryPath","status","pid","port","apiKey","managementKey","autoUpdate","autoStart","healthStatus","configOverrides","errorMessage","logsBufferPath","providerExpose","lastSyncAt"]),s=["updated_at = datetime('now')"],l={tool:e};for(let[e,t]of Object.entries(r)){if(!i.has(e))continue;let r=e.replace(/([A-Z])/g,"_$1").toLowerCase();"configOverrides"===e?(s.push("config_overrides = @configOverrides"),l.configOverrides=n(t)):"autoUpdate"===e||"autoStart"===e||"providerExpose"===e?(s.push(`${r} = @${e}`),l[e]=+(!0===t)):null===t?s.push(`${r} = null`):(s.push(`${r} = @${e}`),l[e]=t)}return a.prepare(`UPDATE version_manager SET ${s.join(", ")} WHERE tool = @tool`).run(l),o(e)}async function l(e){return(0,t.getDbInstance)().prepare("DELETE FROM version_manager WHERE tool = ?").run(e).changes>0}async function u(e,n){return(0,t.getDbInstance)().prepare("UPDATE version_manager SET health_status = ?, last_health_check = datetime('now') WHERE tool = ?").run(n,e).changes>0}async function c(e,n,r){return(0,t.getDbInstance)().prepare(`UPDATE version_manager SET ${n} = ?, updated_at = datetime('now') WHERE tool = ?`).run(r,e).changes>0}async function p(e,n,r,a){return(0,t.getDbInstance)().prepare(void 0!==r?"UPDATE version_manager SET status = ?, pid = ?, error_message = ?, updated_at = datetime('now') WHERE tool = ?":"UPDATE version_manager SET status = ?, error_message = ?, updated_at = datetime('now') WHERE tool = ?").run(...void 0!==r?[n,r,a??null,e]:[n,a??null,e]).changes>0}async function d(e){return o(e)}let _=new Set(["logsBufferPath","providerExpose","lastSyncAt","status","pid","port","apiKey","autoStart","autoUpdate","healthStatus","errorMessage","currentVersion","installedVersion","binaryPath"]);async function E(e,t,n){if(!_.has(t))throw Error(`updateServiceField: field "${t}" is not in the allowed list`);return s(e,{[t]:n})}e.s(["deleteVersionManagerTool",0,l,"getServiceRow",0,d,"getVersionManagerStatus",0,a,"getVersionManagerTool",0,o,"setToolStatus",0,p,"updateServiceField",0,E,"updateToolHealth",0,u,"updateToolVersion",0,c,"updateVersionManagerTool",0,s,"upsertVersionManagerTool",0,i])},682815,e=>{"use strict";var t=e.i(899378);function n(e){return{host:e.host,enabled:1===e.enabled,label:e.label,kind:e.kind,added_at:e.added_at,last_seen_at:e.last_seen_at}}e.s(["addCustomHost",0,function(e,n="custom",r){let a=(0,t.getDbInstance)(),o=new Date().toISOString();a.prepare(`INSERT OR IGNORE INTO inspector_custom_hosts (host, enabled, label, kind, added_at)
     ...
     VALUES (?, ?, ?, ?, ?, ?)`).run(e,t,n,a,o??null,i??1)},"disconnectServer",0,function(e){r().prepare("UPDATE community_servers SET status = 'disconnected' WHERE id = ?").run(e)},"getAggregateXp",0,function(){let e=r().prepare(`SELECT COALESCE(SUM(total_xp), 0) AS total_xp,
     ...
     DO UPDATE SET score = score + excluded.score, updated_at = datetime('now')`).run(e,t,n)}])},795769,e=>{"use strict";var t=e.i(666680),n=e.i(899378),r=e.i(529646);function a(e){let t=(0,n.getDbInstance)().prepare("SELECT * FROM relay_tokens WHERE id = ?").get(e);return t?{...(0,r.rowToCamel)(t),enabled:1===t.enabled}:null}e.s(["checkRateLimit",0,function(e,t){let a=(0,n.getDbInstance)(),o=t;if(!o){let t=a.prepare("SELECT * FROM relay_tokens WHERE id = ?").get(e);if(!t)return{allowed:!1,remaining:0,resetIn:0};o=(0,r.rowToCamel)(t)}let i=Math.floor(Date.now()/1e3),s=60*Math.floor(i/60),l=86400*Math.floor(i/86400),u=a.prepare("SELECT request_count, cost FROM relay_rate_limits WHERE token_id = ? AND window_start = ?").get(e,s),c=u?.request_count||0;if(c>=o.maxRequestsPerMinute)return{allowed:!1,remaining:0,resetIn:60-i%60};let p=a.prepare("SELECT SUM(request_count) as total FROM relay_rate_limits WHERE token_id = ? AND window_start >= ?").get(e,l),d=p?.total||0;return d>=o.maxRequestsPerDay?{allowed:!1,remaining:0,resetIn:86400-i%86400}:{allowed:!0,remaining:Math.min(o.maxRequestsPerMinute-c,o.maxRequestsPerDay-d),resetIn:60-i%60}},"createRelayToken",0,function(a){let o=(0,n.getDbInstance)(),i="rl_"+(0,t.randomBytes)(16).toString("hex"),s="relay_"+(0,t.randomBytes)(24).toString("hex"),l=function(t){let{createHash:n}=e.r(666680);return n("sha256").update(t).digest("hex")}(s),u=Math.floor(Date.now()/1e3),c="rl_"+s.slice(6,14);o.prepare(`
  ...
  `).run(e,o,t.cost||0,t.cost||0),r.prepare("UPDATE relay_tokens SET last_used_at = ? WHERE id = ?").run(a,e),r.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  `).run(e,t.requestId||null,t.model||null,t.promptTokens||0,t.completionTokens||0,t.cost||0,t.status||"success",t.statusCode||200,t.latencyMs||0,t.clientIp||null,t.userAgent||null,a)},"toggleRelayToken",0,function(e,t){let r=(0,n.getDbInstance)(),o=Math.floor(Date.now()/1e3);return r.prepare("UPDATE relay_tokens SET enabled = ?, updated_at = ? WHERE id = ?").run(+!!t,o,e),a(e)},"updateRelayToken",0,function(e,t){let r=(0,n.getDbInstance)(),o=Math.floor(Date.now()/1e3),i=["updated_at = ?"],s=[o];return void 0!==t.name&&(i.push("name = ?"),s.push(t.name)),void 0!==t.description&&(i.push("description = ?"),s.push(t.description)),void 0!==t.comboId&&(i.push("combo_id = ?"),s.push(t.comboId)),void 0!==t.allowedModels&&(i.push("allowed_models = ?"),s.push(JSON.stringify(t.allowedModels))),void 0!==t.maxTokensPerRequest&&(i.push("max_tokens_per_request = ?"),s.push(t.maxTokensPerRequest)),void 0!==t.maxRequestsPerMinute&&(i.push("max_requests_per_minute = ?"),s.push(t.maxRequestsPerMinute)),void 0!==t.maxRequestsPerDay&&(i.push("max_requests_per_day = ?"),s.push(t.maxRequestsPerDay)),void 0!==t.maxCostPerDay&&(i.push("max_cost_per_day = ?"),s.push(t.maxCostPerDay)),s.push(e),r.prepare(`UPDATE relay_tokens SET ${i.join(", ")} WHERE id = ?`).run(...s),a(e)}])},926028,e=>{"use strict";var t=e.i(689960),n=e.i(935050),r=e.i(899378),a=e.i(529646);let o="default-caveman",i="Standard Savings",s="Default RTK + Caveman compression pipeline";function l(){return[{engine:"rtk",intensity:"standard"},{engine:"caveman",intensity:"full"}]}function u(e,t){if(Array.isArray(e))return e;if("string"!=typeof e)return t;try{let n=JSON.parse(e);return Array.isArray(n)?n:t}catch{return t}}let c=["lite","caveman","aggressive","ultra","rtk","headroom","session-dedup","ccr","llmlingua","relevance"];function p(e){return u(e,[]).filter(e=>e&&"object"==typeof e&&c.includes(String(e.engine)))}function d(){let e=(0,r.getDbInstance)();e.exec(`
  ...
  0
       ...
       GROUP BY provider ORDER BY entries DESC`).all(),o={};for(let e of a)o[e.provider]={entries:e.entries,chars:e.chars};let i=e.prepare(`SELECT model, COUNT(*) as entries, COALESCE(SUM(char_count), 0) as chars
       FROM reasoning_cache WHERE ${n} > unixepoch('now')
       ...
       WHERE ${n} > unixepoch('now') ORDER BY created_at DESC LIMIT 1`).get();return{totalEntries:r.total_entries,totalChars:r.total_chars,byProvider:o,byModel:s,oldestEntry:l?.created_at??null,newestEntry:u?.created_at??null}},"setReasoningCache",0,function(e,n,r,a,o=72e5){a.length>1e4&&(a=a.slice(0,1e4));let i=(0,t.getDbInstance)(),s=Math.floor((Date.now()+o)/1e3),l=a.length;i.prepare(`INSERT OR REPLACE INTO reasoning_cache
       (tool_call_id, provider, model, reasoning, char_count, created_at, expires_at)
     VALUES (?, ?, ?, ?, ?, datetime('now'), ?)`).run(e,n,r,a,l,s)}])},188693,e=>{"use strict";var t=e.i(899378);function n(e){if("number"==typeof e&&Number.isFinite(e))return e;if("string"==typeof e&&e.trim()){let t=Number(e);return Number.isFinite(t)?t:null}return null}function r(e){return null!==e&&Number.isFinite(e)?Math.max(0,Math.min(100,e)):null}function a(e){let t=r(e);return null===t?null:Math.max(0,Math.min(100,100-t))}function o(e,t){return null!==e&&(t<=1&&e>t||e-t>=5)}function i(e){if(!e)return null;let t=Date.parse(e);return Number.isFinite(t)?new Date(t).toISOString():null}function s(e){let t=i(e);return t?t.slice(0,10):null}function l(e,n,u=Date.now()){let c=function(e,n,r=Date.now()){if(!e||!n)return null;let a=s(n);if(!a)return null;let o=(0,t.getDbInstance)(),l=new Date(r).toISOString();try{for(let t of o.prepare(`
        SELECT
      ...
      `).all({connectionId:e,nowIso:l}))if(s(t.windowResetsAt)===a)return i(t.windowStartedAt);return null}catch(e){if(e instanceof Error&&e.message.includes("no such table"))return null;throw e}}(e,n,u),p=function(e,n,l=Date.now()){if(!e||!n)return null;let u=s(n);if(!u)return null;let c=(0,t.getDbInstance)(),p=new Date(l).toISOString();try{let t=c.prepare(`
        SELECT
  ...
  `).run(o,i,s,c,p,r,e,e)},"getCompressionAnalyticsSummary",0,function(e){let n=(0,t.getDbInstance)();a();let r=null;"24h"===e?r=new Date(Date.now()-864e5).toISOString():"7d"===e?r=new Date(Date.now()-6048e5).toISOString():"30d"===e&&(r=new Date(Date.now()-2592e6).toISOString());let o=r?"WHERE timestamp >= ?":"",i=r?[r]:[],s=u(o,"skip_reason IS NULL"),l=n.prepare(`
    SELECT
      COUNT(*) as total,
  ...
  `).all(...i),N={},v=0;for(let e of D)N[e.reason??"unknown"]=e.cnt,v+=e.cnt;return{totalRequests:l?.total??0,totalTokensSaved:l?.totalSaved??0,avgSavingsPct:Math.round(l?.avgPct??0),avgDurationMs:Math.round(l?.avgDur??0),byMode:d,byEngine:E,byCompressionCombo:m,byProvider:f,last24h:R,totalSkipped:v,bySkipReason:N,validationFallbacks:I?.cnt??0,realUsage:h,mcpDescriptionCompression:{snapshots:O?.cnt??0,estimatedTokensSaved:O?.saved??0}}},"getPerEngineAnalytics",0,function(e,n=7){let r=(0,t.getDbInstance)();a(),s();let o=new Date(Date.now()-864e5*n).toISOString(),i=r.prepare(`SELECT COUNT(*) AS runs,
    ...
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`).run(e.id,e.name,e.version,e.description??null,e.author??null,e.license??"MIT",e.main,e.source??"local",JSON.stringify(e.tags??[]),e.status??"installed",+!!e.enabled,JSON.stringify(e.manifest),JSON.stringify(e.config??{}),JSON.stringify(e.configSchema??{}),JSON.stringify(e.hooks??[]),JSON.stringify(e.permissions??[]),e.pluginDir,o,o),n.info("plugin.inserted",{id:e.id,name:e.name});let i=a(e.name);if(!i)throw Error(`Failed to retrieve plugin '${e.name}' after insertion`);return i},"listPlugins",0,function(e){let n=(0,t.getDbInstance)();return(e?n.prepare("SELECT * FROM plugins WHERE status = ? ORDER BY name").all(e):n.prepare("SELECT * FROM plugins ORDER BY name").all()).map(r)},"pluginExists",0,function(e){return!!(0,t.getDbInstance)().prepare("SELECT 1 FROM plugins WHERE name = ?").get(e)},"updatePluginConfig",0,function(e,n){let r=(0,t.getDbInstance)(),a=new Date().toISOString();return r.prepare("UPDATE plugins SET config = ?, updated_at = ? WHERE name = ?").run(JSON.stringify(n),a,e).changes>0},"updatePluginStatus",0,function(e,r,a){let o=(0,t.getDbInstance)(),i=new Date().toISOString(),s="active"===r?i:null,l=o.prepare(`UPDATE plugins SET status = ?, enabled = ?, error_message = ?,
       updated_at = ?, activated_at = COALESCE(?, activated_at)
       WHERE name = ?`).run(r,+("active"===r),a??null,i,s,e);return l.changes>0&&n.info("plugin.status_updated",{name:e,status:r}),l.changes>0}])},54572,e=>{"use strict";var t=e.i(254799),n=e.i(899378),r=e.i(935050);function a(e){return{id:String(e.id??""),source:String(e.source??"1proxy"),host:String(e.host??""),port:Number(e.port)||0,type:String(e.type??"http"),countryCode:null!=e.country_code?String(e.country_code):null,qualityScore:null!=e.quality_score?Number(e.quality_score):null,latencyMs:null!=e.latency_ms?Number(e.latency_ms):null,anonymity:null!=e.anonymity?String(e.anonymity):null,lastValidated:null!=e.last_validated?String(e.last_validated):null,inPool:1===e.in_pool||!0===e.in_pool,poolProxyId:null!=e.pool_proxy_id?String(e.pool_proxy_id):null,createdAt:String(e.created_at??""),updatedAt:String(e.updated_at??"")}}async function o(e){let r=(0,n.getDbInstance)(),a=new Date().toISOString(),o=r.prepare("SELECT id FROM free_proxies WHERE source = ? AND host = ? AND port = ?").get(e.source,e.host,e.port);if(o?.id)return r.prepare(`UPDATE free_proxies
       SET type = ?, country_code = ?, quality_score = ?, latency_ms = ?,
           anonymity = ?, last_validated = ?, updated_at = ?
       WHERE id = ?`).run(e.type,e.countryCode??null,e.qualityScore??null,e.latencyMs??null,e.anonymity??null,e.lastValidated??a,a,o.id),{id:o.id,action:"updated"};let i=(0,t.randomUUID)();return r.prepare(`INSERT INTO free_proxies
  ...
  `)}e.s(["getCompressionRunTelemetrySummary",0,function(){let e=(0,t.getDbInstance)();n();let r=e.prepare(`SELECT tokens_before, tokens_after, output_styles, output_style_bypass, output_tokens
     ...
     WHERE webhook_id = ?
       AND id NOT IN (
         ...
         ORDER BY created_at DESC, id DESC
         LIMIT ?
       )`),i=null!=e.error&&(0,n.sanitizeErrorMessage)(e.error)||null;r.transaction(()=>{a.run(e.webhookId,e.eventType,e.status,e.httpStatus??null,e.latencyMs??null,i,e.payloadSnapshot??null),o.run(e.webhookId,e.webhookId,100)})()}])}];

//# sourceMappingURL=_0ox-6sy._.js.map