module.exports=[926554,e=>{"use strict";var t=e.i(666680),r=e.i(899378),a=e.i(529646);function n(e,t,r){return e.prepare(`PRAGMA table_info(${t})`).all().some(e=>e&&"string"==typeof e.name&&e.name===r)}function i(e){e.prepare(`CREATE TABLE IF NOT EXISTS eval_suites (
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
      description TEXT,
...
//# sourceMappingURL=src_lib_0ihae3b._.js.map