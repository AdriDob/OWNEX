"""Windows Service — registers CATEYE as a background Windows Service.
...
SERVICE_NAME = "CATEYE"
SERVICE_DISPLAY_NAME = "CATEYE Investigation OS"
...
if _HAS_PYWIN32:
    ...
    class CATEYEService(_pywin32["serviceutil"].ServiceFramework):  # type: ignore[misc]
        ...
        def _run_backend(self):
            ...
            _lifecycle("[SERVICE]", "CATEYE Service — PID: %d", os.getpid())
            ...
            _lifecycle("[SERVICE]", "CATEYE Service is running")
...
def install_service() -> None:
    ...
    win32serviceutil.HandleCommandLine(CATEYEService)
