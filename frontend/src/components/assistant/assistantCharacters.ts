...
export const assistants: AssistantCharacter[] = [
  {
    ...
    bgGradient: 'from-intigriti/30 to-transparent',
  ...
  },
  {
    ...
    borderColor: 'border-border-light/30',
    messages: [
  ...
  },
  {
    ...
    color: 'text-gold',
    bgGradient: 'from-warning/30 to-transparent',
  ...
  },
  {
    ...
    color: 'text-success',
    bgGradient: 'from-success/30 to-transparent',
