...
# The trading jobs reference handlers like "cores.trading.lifecycle:start_backtest"
...
def _get_lcm() -> StrategyLifecycleManager:
    ...
    from cores.trading.lifecycle import get_lifecycle_manager
...
def _get_lcm() -> StrategyLifecycleManager:
    """Get a StrategyLifecycleManager instance."""
    from cores.trading.lifecycle import StrategyLifecycleManager
