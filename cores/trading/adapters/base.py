...
class EngineAdapter(ABC):
    ...
    async def get_health_status(self) -> EngineHealthStatus:
        ...
        from cores.trading.contracts import EngineHealth, EngineHealthStatus
    ...
    def get_metadata(self) -> EngineMetadata:
        """Get engine metadata."""
        from cores.trading.contracts import EngineHealth, EngineMetadata
    ...
    def _update_activity(self, strategy_id: str, status: StrategyStatus) -> None:
        ...
        from cores.trading.contracts import StrategyStatus
