...
from cores.intelligence.historical_analyzer import (
    HistoricalSummary,
    analyze_historical_data,
)
from cores.intelligence.learning_snapshot import (
    LearningSnapshot,
    generate_snapshot,
)
from cores.intelligence.pattern_registry import PatternRegistry, get_registry
from cores.intelligence.recommendation_engine import (
