...
def score_technology_relevance(technologies: list[str]) -> float:
    ...
    modern_frameworks = {"nextjs", "nuxt", "django", "fastapi", "spring", "laravel", "rails"}
    if tag_set & modern_frameworks:
        score += 25.0

    cloud_platforms = {"aws", "google_cloud", "azure", "cloudflare", "cloudfront", "kubernetes"}
