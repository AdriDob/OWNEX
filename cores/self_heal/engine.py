...
from cores.self_heal.models import HealAction, HealReport
...
class SelfHealEngine:
    ...
    def _fix_broken_init_files(self) -> None:
        broken_patterns = [
            ("core/maintenance/__init__.py", "from cores.maintenance.engine"),
        ]
    ...
    def validate_imports(self) -> list[dict[str, str]]:
        ...
        critical_modules = [
            "api.main",
            "cores.revenue.engine",
            "cores.revenue.tracker",
            "cores.capabilities.registry",
            "cores.self_heal.engine",
            "cores.self_update.engine",
