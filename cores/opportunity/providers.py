...
class PublicProgramProvider(BaseProvider):
    ...
    _SEED_OPPORTUNITIES: list[dict[str, Any]] = [
        ...
        # ── API Ecosystems ──────────────────────────────────────────────
        {
            ...
            "source_type": "api_ecosystem",
            "source_name": "API Ecosystem",
            "source_url": "",
            "public_url": "",
        ...
        # ── Browser Extensions ──────────────────────────────────────────
        {
            ...
            "source_name": "Browser Extensions",
            "source_url": "",
            "public_url": "",
    ...
    def discover(self) -> list[Opportunity]:
        ...
        logger.info(
            "Discovered %d public opportunities (paid-first: %d with rewards)",
    ...
    _SEEDS: list[dict[str, Any]] = [
        {
            ...
            "source_type": "open_source",
            "source_name": "GitHub Security Lab",
