...
from cores.notifications.telegram import renderer as _r  # noqa: N812
...
def _run_max() -> dict[str, Any]:
    try:
        from cores.revenue_multiplier import RevenueMultiplierConfig, RevenueMultiplierOrchestrator
