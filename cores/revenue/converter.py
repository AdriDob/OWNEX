"""Currency conversion + fee math (canonical implementation).

Consolidated here from the legacy twin during CORE→CORES migration so there
is exactly one implementation. Pure functions, no I/O.
"""
