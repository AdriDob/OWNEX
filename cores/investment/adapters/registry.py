...
def build_default_registry(config: dict[str, Any] | None = None) -> InvestmentAdapterRegistry:
    ...
    registry.register_adapter(
        "ccxt",
        "cores.investment.adapters.ccxt_adapter.CCXTAdapter",
    ...
    registry.register_adapter(
        "freqtrade",
        "cores.investment.adapters.freqtrade_adapter.FreqtradeAdapter",
    ...
    registry.register_adapter(
        "hummingbot",
        "cores.investment.adapters.hummingbot_adapter.HummingbotAdapter",
    ...
    registry.register_adapter(
        "polymarket_clob",
        "cores.investment.adapters.polymarket_clob_adapter.PolymarketCLOBAdapter",
    ...
    registry.register_adapter(
        "polymarket",
        "cores.investment.adapters.polymarket_adapter.PolymarketAdapter",
    ...
    registry.register_adapter(
        "quant_research",
        "cores.investment.adapters.quant_research_adapter.VectorBTAdapter",
    ...
    registry.register_adapter(
        "backtrader",
        "cores.investment.adapters.quant_research_adapter.BacktraderAdapter",
    ...
    registry.register_adapter(
        "onchain_analytics",
        "cores.investment.adapters.onchain_analytics_adapter.OnChainAnalyticsAdapter",
    ...
    registry.register_adapter(
        "sentiment",
        "cores.investment.adapters.sentiment_adapter.SentimentAnalyzerAdapter",
    ...
    registry.register_adapter(
        "forex",
        "cores.investment.adapters.forex_adapter.ForexAdapter",
    ...
    registry.register_adapter(
        "futures",
        "cores.investment.adapters.futures_adapter.FuturesAdapter",
    ...
    registry.register_adapter(
        "global_arbitrage",
        "cores.investment.adapters.global_arbitrage_adapter.GlobalArbitrageAdapter",
    ...
    registry.register_adapter(
        "sports_betting",
        "cores.investment.adapters.sports_betting_adapter.SportsBettingAdapter",
    ...
    registry.register_adapter(
        "alpaca",
        "cores.investment.adapters.stocks_adapter.AlpacaAdapter",
        config=config.get("alpaca", {}) if config else {},
        enabled=True,
    )

    registry.register_adapter(
        "ibkr",
        "cores.investment.adapters.stocks_adapter.IBKRAdapter",
        config=config.get("ibkr", {}) if config else {},
        enabled=True,
    )
    ...
    registry.register_adapter(
        "aave",
        "cores.investment.adapters.defi_adapter.AaveAdapter",
        config=config.get("aave", {}) if config else {},
        enabled=True,
    )

    registry.register_adapter(
        "morpho",
        "cores.investment.adapters.defi_adapter.MorphoAdapter",
        config=config.get("morpho", {}) if config else {},
        enabled=True,
    )

    registry.register_adapter(
        "pendle",
        "cores.investment.adapters.defi_adapter.PendleAdapter",
        config=config.get("pendle", {}) if config else {},
        enabled=True,
    )

    registry.register_adapter(
        "lido",
        "cores.investment.adapters.defi_adapter.LidoAdapter",
        config=config.get("lido", {}) if config else {},
        enabled=True,
    )
