...
class ReportExecutor(BaseStageExecutor):
    ...
    def _generate_report(self, bundle: dict[str, Any], target: str, scope: dict[str, Any]) -> dict[str, Any]:
    ...
    def _generate_summary_report(self, reports: list[dict[str, Any]], target: str) -> dict[str, Any]:
    ...
    def _persist_reports(self, target: str, reports: list[dict[str, Any]]) -> None:
        ...
        try:
            ...
            try:
                (session.query(TargetModel).filter(TargetModel.name == target).first())
