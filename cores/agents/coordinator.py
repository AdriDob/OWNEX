...
from cores.agents.types import AgentEvent, AgentId, EventType, PipelineState
from cores.pipeline.state_machine import (
    build_transition,
    can_retry,
...
class CoordinatorAgent(BaseAgent):
    ...
    def _on_submission_requested(self, event: AgentEvent) -> None:
        ...
        # Execute submission
        try:
            from cores.tracking.service import submit_report_to_platform
