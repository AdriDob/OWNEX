...
from cores.execution.models import Workflow
from cores.execution.primitives import PrimitiveType
from cores.execution.validation import BaseValidator, ValidationResult

logger = logging.getLogger("orion.cores.execution.validators.dependency")
...
class DependencyValidator(BaseValidator):
    ...
    def _get_integration_map() -> dict[str, dict]:
        ...
        try:
            from cores.integrations.registry import get_integration_registry
