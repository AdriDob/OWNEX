...
class PlanningEngine:
    ...
    TEMPLATES = {
        ...
        "ai_work": lambda o: [
            ...
            PlanStep(
                "submit", "Submit", "Submit completed work", order=4, capability="api_interaction", estimated_minutes=2
            ),
        ],
    }
    ...
    async def create_plan(
        ...
        if template:
            ...
            steps = [
                ...
                PlanStep(
                    "submit", "Submission", "Submit results", order=3, capability="api_interaction", estimated_minutes=5
                ),
            ]
...
class ExecutionEngine(BasePipelineEngine):
    ...
    async def execute(
        ...
        if self.capability_engine:
            ...
            if not all_ready:
                unavailable = [cap_id for cap_id, r in prep_results.items() if not r.get("available", False)]
