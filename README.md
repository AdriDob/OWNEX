   ...
   <p>
     ...
     <a href="#"><img src="https://img.shields.io/badge/python-3.10%2B-purple.svg" alt="Python 3.10+"/></a>
      <a href="#"><img src="https://img.shields.io/badge/version-Alpha-1.0%20-%20CATEYE-orange.svg" alt="Version Alpha 1.0 - CATEYE"/></a>
   ...
   | [`ROADMAP.md`](ROADMAP.md) | Roadmap de versiones v1.0 → v1.6.0 |
