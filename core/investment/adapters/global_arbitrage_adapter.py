...
def build_global_arbitrage_adapter(config: dict[str, Any] | None = None) -> GlobalArbitrageAdapter:
    """Factory function to create Global Arbitrage adapter."""
    return GlobalArbitrageAdapter(config)
