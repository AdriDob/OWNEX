"""Convert boot animation concept to PNG."""
...
convert_svg_to_png(CONCEPTS_DIR / "boot_animation_concept.svg", PROFESSIONAL_DIR / "boot_animation_concept.png", width=1200)

print(f"\nBoot animation concept converted to PNG in: {PROFESSIONAL_DIR}")
