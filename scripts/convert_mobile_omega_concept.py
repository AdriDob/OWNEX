"""Convert Mobile Omega concept to PNG."""
...
convert_svg_to_png(CONCEPTS_DIR / "mobile_omega_concept.svg", PROFESSIONAL_DIR / "mobile_omega_concept.png", width=1200)

print(f"\nMobile Omega concept converted to PNG in: {PROFESSIONAL_DIR}")
